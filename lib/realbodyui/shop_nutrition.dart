...
class ShopNutrition extends StatefulWidget {
  final int id;
  ShopNutrition({this.id});
  @override
  _ShopNutritionState createState() => _ShopNutritionState();
}

class _ShopNutritionState extends State<ShopNutrition> {
  @override
...
children: <Widget>[
  ...
  child:   Container(child: Text("Nutritions",style: TextStyle(fontWeight: FontWeight.w900,fontSize: 25.0),),),
),
           ProgramList(title:"Build Muscle Protien", description:"Write Description Here",id: widget.id,programId: 1,image: "assets/images/nutrition.png"),
           SizedBox(height: 10,),
           ProgramList(title:"Build Muscle Protien", description:"Write Description Here",id: widget.id,programId: 1,image: "assets/images/nutrition.png"),
            SizedBox(height: 10,),
           ProgramList(title:"Build Muscle Protien", description:"Write Description Here",id: widget.id,programId: 1,image: "assets/images/nutrition.png"),
